    ...
    >
          ...
          >
            ...
            >
              ...
              <input
                ...
                onFocus={e => {
                  if (!error) e.target.style.borderBottomColor = '#842bd2';
                }}
                onBlur={e => {
                  if (!error) e.target.style.borderBottomColor = '#474747';
                }}
              />
            </div>
            ...
            <button
              ...
              onMouseEnter={e => {
                (e.target as HTMLButtonElement).style.background = '#842bd2';
      ...
      {phase === 'portal' && (
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
              ...
              <button
                ...
                onMouseLeave={e => {
                  const el = e.currentTarget;
                  el.style.borderColor = '#474747';
                  el.style.color = '#919191';
                }}
              >
                LOCK
              </button>
          ...
          >
            <span style={{ fontSize: '0.6rem', letterSpacing: '0.2em', color: '#353535', textTransform: 'uppercase' }}>
